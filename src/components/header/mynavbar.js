    ...
    <Navbar collapseOnSelect expand="lg" bg="" variant="" >
      <Container className="mb-3" fluid>
        ...
        <Nav className="me-auto d-flex width-50 justify-content-around">
            <NavLink to='/' className={(link)=>link.isActive ? `${headerStyle['active-link']} fColor3 fw-bold text-decoration-none` : 'fColor3 fw-bold text-decoration-none'}> صفحه اصلی </NavLink>
            <NavLink to='/products' className={(link)=>link.isActive ? `${headerStyle['active-link']} fColor3 fw-bold text-decoration-none` : 'fColor3 fw-bold text-decoration-none'}>محصولات</NavLink>
            <NavLink to='/contact-us' className={(link)=>link.isActive ? `${headerStyle['active-link']} fColor3 fw-bold text-decoration-none` : 'fColor3 fw-bold text-decoration-none'}>ارتباط با ما</NavLink>
